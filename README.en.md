...
|------|------|------|
| Backend framework | Spring Boot 4.1.1 (JDK 17) | REST API |
| Database | MySQL 5.7+/8.0 + MyBatis-Plus 3.5.17 | Persistence & ORM |
| Cache | Redis 7.2.15 + Lettuce + Redisson 4.7.0 | Multi-level cache / distributed locks / GEO / BitMap / Stream |
| AI | Spring AI 2.0.1 | Intelligent Q&A / RAG / chat memory / tool calling |
