...
const routes = [
  ...
  { path: '/map', name: 'map', component: () => import('@/views/Placeholder.vue'), meta: { title: '地图' } },
  { path: '/ai', name: 'aiassistant', component: () => import('@/views/Placeholder.vue'), meta: { title: 'AI 探店助手' } },
  // 兜底：未知路径回首页
