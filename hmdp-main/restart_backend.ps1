...
$jar = Join-Path $PSScriptRoot "target\hm-dianping-0.0.1-SNAPSHOT.jar"
$proc = Start-Process -FilePath "java" -ArgumentList "-jar", $jar -WorkingDirectory $PSScriptRoot -WindowStyle Minimized -PassThru
