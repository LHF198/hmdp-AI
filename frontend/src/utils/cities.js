/**
 * 全国省/自治区/直辖市/特别行政区 → 地级市（州/盟/地区）数据
 * 供首页"地区"两级选择器、发笔记页城市选择等复用
 * 数据结构：export const CITY_DATA = [{ name: "浙江省", cities: ["杭州", ...] }, ...]
 */
export const CITY_DATA = [
  ...
  },
  {
    name: "海南省",
    cities: [
      "海口", "三亚", "三沙", "儋州", "五指山", "琼海", "文昌",
      "万宁", "东方", "定安", "屯昌", "澄迈", "临高", "白沙",
      "昌江", "乐东", "陵水", "保亭", "琼中",
    ],
  },
  {
  ...
  },
  {
    name: "新疆维吾尔自治区",
    cities: [
      "乌鲁木齐", "克拉玛依", "吐鲁番", "哈密", "昌吉", "博尔塔拉",
      "巴音郭楞", "阿克苏", "克孜勒苏", "喀什", "和田", "伊犁",
      "塔城", "阿勒泰", "石河子", "阿拉尔", "图木舒克", "五家渠",
      "北屯", "铁门关", "双河", "可克达拉", "昆玉", "胡杨河", "新星",
    ],
  },
  {
    name: "台湾省",
    cities: ["台北", "高雄", "台中", "台南", "新北", "桃园", "基隆", "新竹", "嘉义"],
  },
